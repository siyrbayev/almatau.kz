...
const API_BASE = import.meta.env.VITE_API_BASE || 'https://api.wipon.kz';
const AUTH_PATH = import.meta.env.VITE_WIPON_AUTH_PATH || '/v1/oauth/token';
const USERNAME = import.meta.env.VITE_WIPON_USER;
const PASSWORD = import.meta.env.VITE_WIPON_PASS;
